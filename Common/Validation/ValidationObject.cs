...
namespace Common.Validation
{
    public class ValidationObject : IValidationObject
    {
        ...
        public bool Validate<T>(T obj, [CallerMemberName]string propertyName = "")
        {
            return ValidateValue(obj, true, propertyName);
        }


        public bool Check<T>(T obj, [CallerMemberName]string propertyName = "")
        {
            return ValidateValue(obj, false, propertyName);
        }


        private bool ValidateValue<T>(T obj, bool collectErrors = false, [CallerMemberName]string propertyName = "")
        {
            if (string.IsNullOrEmpty(propertyName)) {
